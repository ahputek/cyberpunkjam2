...
namespace Framework.MVC
{
    ...
    public class BaseApplication : Element
    {
        ...
        virtual protected void Start()
        {
			...
			if (m_first_scene) { m_first_scene = false; OnLevelWasLoaded(UnityEngine.SceneManagement.SceneManager.GetActiveScene().buildIndex); }
        }
        ...
        {
			Notify("scene.load", new object[] { UnityEngine.SceneManagement.SceneManager.GetActiveScene().name, UnityEngine.SceneManagement.SceneManager.GetActiveScene().buildIndex });
        }
        ...
        public void SceneAdd(string p_name, bool p_async, params string[] p_args)
        {
            ...
            else
            {
				...
				UnityEngine.SceneManagement.SceneManager.LoadScene(p_name, LoadSceneMode.Additive);
            }
        }
        ...
        private IEnumerator SceneLoadAsync(string p_name,bool p_additive,params string[] p_args)
        {
            ...
            if(p_additive)
            {
				...
				async = UnityEngine.SceneManagement.SceneManager.LoadSceneAsync(p_name, LoadSceneMode.Additive);
            }
            else
            {
                ev = "scene.load.progress";
				async = UnityEngine.SceneManagement.SceneManager.LoadSceneAsync(p_name);
            }
